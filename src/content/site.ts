...
export const FAQ = [
  ...
  { q: "What if I don't love it?", a: "Message us within 30 days of your first order and mail back what is left of the bag. Once it arrives, we will refund you. This covers your first order, once per customer. It is separate from the ship-window promise above, that one covers us being late, this one covers you not liking the coffee." },
];
