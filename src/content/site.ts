...
export const PROCESS = [
  ...
  { word: "Sealed", clip: import.meta.env.BASE_URL + "assets/video/sealed-tile.mp4", poster: import.meta.env.BASE_URL + "assets/video/sealed-tile.jpg", copy: "Whole bean or ground to your brew, then sealed at origin. Blue Mountain is a protected product and cannot be repacked once it leaves the island." },
